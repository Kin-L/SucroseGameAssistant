...
def FightCommon(self, common):
    ...
    self.ctler.waitTo("速战", (1387, 945, 1599, 1075))
    self.ctler.click_to_text((1491, 1006), "开始作战", (861, 804, 1057, 871))
    self.ctler.click((1280, 711))
    self.ctler.wait(0.6)
    self.ctler.click_text("开始", (858, 801, 1072, 875))
    self.ctler.wait(0.5)
...
def snowEnergy(self):
    self.send("开始检查：感知扫荡")
    if self.para["Email"]:
        if self.ctler.findcolor("FFFF8B", (167, 443, 175, 455)):
