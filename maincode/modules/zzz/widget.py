...
class zzzPage(ModuleStackPage):
    def __init__(self):
        super().__init__()
        self.page00: Optional[zzzPage00Set] = None
        self.pbset00 = SetButton(self, (180, 10, 25, 25), (25, 25))

    def LoadWidget(self):
        self.page00 = zzzPage00Set()
    ...
    def open_Onedragon(self):
        weopen("https://one-dragon.com/zzz/zh/home.html")
...
class zzzPage00Set(SetStackPage):
    def __init__(self):
        ...
        tips(self.path, '请填写或选择绝区零一条龙的路径')
        self.path.setText("D:\ZenlessZoneZero-OneDragon\OneDragon-Launcher.exe")  # 设置默认路径
        ...
        self.button_Onedragon = Button(self, (10, 260, 100, 50), "绝区零一条龙下载")
