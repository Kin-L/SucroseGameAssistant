...
class SGAMain2(SGAMain1):
    ...
    def NewThread(self, tasktype, para):
        try:
            ...
            print(e)
        self.taskthread = SGAMainThread(tasktype, para)
        self.thread = QThread()
        self.taskthread.moveToThread(self.thread)
        self.taskthread.infoHead.connect(self.infoHead)
        self.taskthread.infoAdd.connect(self.infoAdd)
        self.taskthread.infoEnd.connect(self.infoEnd)
