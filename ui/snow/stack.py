...
class Local:
    def __init__(self, stack):
        ...
        self.label_tools = Label(self.page_local, (0, 370, 220, 27), "实用工具：")
        self.button_wiki = Button(self.page_local, (0, 405, 100, 30), "天启者图鉴")
...
class Fight:
    def __init__(self, stack):
        ...
        self.check_common = Check(self.page_fight, (15, 155, 140, 22), "完成一次常规行动")
