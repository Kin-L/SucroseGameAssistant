...
class Snow:
    ...
    def input_config(self, _dir):
        ...
        self.set.check_roll3.setChecked(config["共鸣记录"][3])
        self.set.check_roll4.setChecked(config["共鸣记录"][4])
        self.set.check_roll5.setChecked(config["共鸣记录"][5])
        self.set.check_roll6.setChecked(config["共鸣记录"][6])
        self.set.check_opensheet.setChecked(config["共鸣记录"][7])
