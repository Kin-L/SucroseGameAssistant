...
class GenshinList:
    def __init__(self, widget, location):
        ...
        self.check_pot = Check(self.widget, (15, 230, 140, 22), "尘歌壶")
        self.check_mail = Check(self.widget, (15, 275, 140, 22), "领取邮件")
        self.check_tree = Check(self.widget, (15, 320, 140, 22), "自动伐木")
        self.check_daily = Check(self.widget, (15, 365, 140, 22), "体力日常")
        self.check_pass = Check(self.widget, (15, 410, 140, 22), "领取纪行")
        ...
        self.set_pot = PicButton(self.widget, (180, 230, 22, 22), setpath, (22, 22))
        self.set_mail = PicButton(self.widget, (180, 275, 22, 22), setpath, (22, 22))
        self.set_tree = PicButton(self.widget, (180, 320, 22, 22), setpath, (22, 22))
        self.set_daily = PicButton(self.widget, (180, 365, 22, 22), setpath, (22, 22))
        self.set_pass = PicButton(self.widget, (180, 410, 22, 22), setpath, (22, 22))
