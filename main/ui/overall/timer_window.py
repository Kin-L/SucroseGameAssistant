from main.ui.control import (Button, Widget, Label,
                             PicButton, Combobox, Check,
                             ScrollArea, Timepicker)


class TimerWindow:
    def __init__(self, _widget, _location):
        super().__init__()
        widget = Widget(_widget, _location)
        self.time_item = 3
        # 时间条目控制
        self.label_item = Label(widget, (0, 0, 100, 30), "时间条目增减")

        self.add = PicButton(widget, (110, 0, 30, 30),
                             r"assets\main_window\button/add.png",
                             (20, 20))
        self.deduce = PicButton(widget, (150, 0, 30, 30),
                                r"assets\main_window\button/reduce.png",
                                (20, 20))
        self.apply = PicButton(widget, (190, 0, 30, 30),
                               r"assets\main_window\button/save.png",
                               (20, 20))
        ...
        self.timer0 = Timepicker(self.widget, (100, 5, 50, 30))
        self.timer1 = Timepicker(self.widget, (100, 45, 50, 30))
        self.timer2 = Timepicker(self.widget, (100, 85, 50, 30))
        self.timer3 = Timepicker(self.widget, (100, 125, 50, 30))
        self.timer4 = Timepicker(self.widget, (100, 165, 50, 30))
        self.timer5 = Timepicker(self.widget, (100, 205, 50, 30))
        self.timer6 = Timepicker(self.widget, (100, 245, 50, 30))
        self.timer7 = Timepicker(self.widget, (100, 285, 50, 30))
        self.timer8 = Timepicker(self.widget, (100, 320, 50, 30))
        self.timer9 = Timepicker(self.widget, (100, 360, 50, 30))
